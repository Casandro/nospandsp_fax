...
static void md5_compress(u32 s[4], const u8 *block) {
    u32 a=s[0],b=s[1],c=s[2],d=s[3],x[16];
    for(int i=0;i<16;i++)
        x[i]=(u32)block[i*4]|((u32)block[i*4+1]<<8)|((u32)block[i*4+2]<<16)|((u32)block[i*4+3]<<24);
